...
const items=[
    {id:1, alt:"画像", img:"/images/02_phone (1).png",pbl:"課題：",mur:"施策：",ach:"成果：",name:"肉亭ふたご様（焼き肉）",bold:"立地が分かりにくく、SNSが強みを伝えきれていなかった 。",bold1:"「特別な体験ができるプライベート焼肉」を軸に、シェフのこだわりや料理工程を通して“物語性”を演出",bold3:"導入6ヶ月でSNS経由の来店20組を突破。SNS経由の問い合わせ・予約導線を確立"},
    {id:2, alt:"画像", img:"/images/01_phone (1).png",pbl:"課題：",mur:"施策：",ach:"成果：",name:"Wagyu Stall様（渋谷/ストリートフード）",bold:"好立地だがターゲット層に届かずSNS活用法も不明だった。",bold1:"「渋谷」「バーガー」「ストリートフード」を軸に、ムスリム観光客の興味を引く動画戦略を設計。",bold3:"導入3ヶ月で過去最高売上を達成。TikTokとInstagramで拡散され、コミュニティ内で一気に話題化 。最高再生数 320,000回 、ブックマーク 13,000件"},
    {id:3, alt:"画像", img:"/images/03_phone (1).png",pbl:"課題：",mur:"施策：",ach:"成果：",name:"新宿亭様（ラーメン）",bold:"自社からの発信力を強化してターゲット層へ届けたいと考えていた。",bold1:"「ラーメン」「和牛」「ハラール」の3要素をブランド軸とし、一人のシェフにフォーカスしたキャラクターを構築 ",bold3:"最高再生数 566,800回、いいね 38,000件を達成。 フォロワー 8,302人 を獲得"}
]
